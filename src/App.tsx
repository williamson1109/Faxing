...
export default function App() {
  ...
  const ongoingDetails = activeEventId?.startsWith('{') ? JSON.parse(activeEventId) as { name: string; official: boolean } : null
